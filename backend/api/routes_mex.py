...
async def create_mexicano(req: CreateMexicanoRequest):
...
async def mex_record(tid: str, req: RecordScoreRequest):
    t: MexicanoTournament = _get_tournament(tid, _MEX)["tournament"]
    try:
...
async def mex_next_round(tid: str, req: NextRoundRequest = NextRoundRequest()):
    t: MexicanoTournament = _get_tournament(tid, _MEX)["tournament"]
...
async def mex_custom_round(tid: str, req: CustomRoundRequest):
...
async def mex_start_playoffs(tid: str, req: StartMexicanoPlayoffsRequest):
...
async def mex_record_playoff(tid: str, req: RecordScoreRequest):
